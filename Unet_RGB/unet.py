...
store_weights = "/scratch/muneebm/weights/easy_medium/correct_unet_RGB_curriculum_300_patch_weights_rust_notrust"
...
# devide data into easy, medium, and hard data for curriculum learning
easy_label.sort()
rust_easy.sort()
medium_label.sort()
rust_medium.sort()
...
print(f"easy_label={len(easy_label)} medium_label={len(medium_label)} hard_label={len(hard_label)} not_rust_label={len(not_rust_label)}")
